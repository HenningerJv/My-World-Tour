  ...
  return (
    <LinearGradient colors={['#00FF94', '#00FF94', '#2F829C']} style={styles.linearGradient}>
      <View style={styles.container}>
        ...
        <Picker selectedValue={nacionalidade} onValueChange={(itemValue) => setNacionalidade(itemValue)} style={styles.picker}>
        ...
        <TextInput secureTextEntry={true} style={styles.textInput} placeholder="Confirme sua senha:" onChangeText={text => setConfirmeSenha(text)} value={confirmeSenha} />
